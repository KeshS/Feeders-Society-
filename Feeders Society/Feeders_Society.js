...
var options ={
    ...
    identity: {
        username: "smileyfacebot",
        password: "oauth:9nuugphd8bho90f8kefpt0zunau95f"
    },
...
function getStaffRank(username){
	getStaff();
	for(var i=0;)
}
...
client.on("chat", function (channel, user, message, self) {
	...
	if(args[0]=="!test"){
		client.say(options.channels[0],getStaff());
	}
...
var logFile = io.readFile('/var/lib/openshift/583dc32f0c1e66954200003e/nodejs/twitch/Feeders_Society/log.txt');
var str = username+": ";
var d =new Date();
var seconds;
var minutes;
...
io.writeFile('/var/lib/openshift/583dc32f0c1e66954200003e/nodejs/twitch/Feeders_Society/log.txt',logFile+"<p>"+d.getDate()+"/"+(d.getMonth()+1)+"/"+d.getFullYear()+" "+d.getHours()+":"+
	minutes+":"+seconds+" " +str.bold() +message + " </p>", function(err) {if (err !== null) { console.log ('Error reading file:'); console.log (err);}}); 
}
